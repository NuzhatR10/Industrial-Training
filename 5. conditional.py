...
residency = input("Are you a resident? (yes/no): ").strip().lower()  # Residency status

# Check eligibility
if age >= 60 and residency == "yes":
    print("You are eligible for the senior citizen discount.")
elif age >= 60 and residency == "no":
    print("You meet the age criteria but are not eligible due to non-residency.")
else:
    print("You do not meet the age requirement for the senior citizen discount.")
...
weather = input("Enter the weather condition (sunny, snowy, rainy): ").strip().lower()

# Categorize the day
if temperature > 25 and weather == "sunny":
    print("It's a beach day! Enjoy the sun.")
elif temperature <= 0 and weather == "snowy":
    print("It's a skiing day! Time to hit the slopes.")
elif weather == "rainy" or (temperature >= 10 and temperature <= 20):
    print("It's a stay-home day! Relax and stay cozy.")
else:
    print("It's a regular day. Enjoy it as you like!")

...
# Creating a string containing simple bio data
bio_data = "Name: Alice, Age: 25, Country: USA"

# Extracting each piece of information by splitting the string
bio_data_parts = bio_data.split(", ")  # Splits the string into a list of key-value pairs

# Extracting and printing each piece of information
for part in bio_data_parts:
    key, value = part.split(": ")  # Splits each key-value pair
    print(f"{key}: {value}")
...
formatted_string = (
    f"My name is {person_info['name']}, I am {person_info['age']} years old, "
    f"I live in {person_info['city']}, and I work as a {person_info['profession']}."
)
...
# Example usage
sample_string = "Hello, Python enthusiasts!"
result = character_count(sample_string)
...
hashtag_regex = r'#\w+'  # Matches a '#' followed by one or more word characters (letters, digits, or underscores)
...
# Updated regex to match valid Bangladesh phone numbers
phone_regex = r'\b(?:\+880|0088|01)\d{9}|\b01\d{4}-\d{6}\b'

# Example input text containing various phone number formats
text = "Here are some Bangladesh phone numbers: 01454565767, +880196345634, 0088785674657, 01845-567567, 88785674657."

# Find all phone numbers
phone_numbers = re.findall(phone_regex, text)

# Print the matched phone numbers
print("Bangladesh phone numbers found:", phone_numbers)
